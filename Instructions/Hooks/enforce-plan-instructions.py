#!/usr/bin/env python3
"""
Hook: Enforce calling GetInstructions("plan") before gh issue/pr operations.
...
Flow:
1. GetInstructions("plan") generates a token and writes to .roslyn-mcp/plan-token
...
def main():
    ...
    if not roslyn_dir:
        ...
        print('Run: GetInstructions(topic: "plan")', file=sys.stderr)
        sys.exit(2)
